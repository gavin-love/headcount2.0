...
describe("CompareCardContainer", () => {
  ...
  beforeEach(() => {
    ...
    mockData = [
      {
        average: 34,
        findAverages: { mockFunction },
        location: "colorado",
        stats: { 2004: 0.24, 2005: 0.63, 2006: 0.11 }
      },
      {
        average: 12,
        findAverages: { mockFunction },
        location: "academy 20",
        stats: { 2012: 0.24, 2013: 0.63, 2014: 0.11 }
      },
      {
  ...
  it("should", () => {
    wrapper = shallow(<CompareCardsContainer selectedDistricts={mockData} />);
